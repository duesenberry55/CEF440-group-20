...
class RespondSignUpScreen extends StatefulWidget {
  static const id = 'respondsignup';

  @override
  _RespondSignUpScreenState createState() => _RespondSignUpScreenState();
}

class _RespondSignUpScreenState extends State<RespondSignUpScreen> {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Successfully created account as report'),
            ),
          );
